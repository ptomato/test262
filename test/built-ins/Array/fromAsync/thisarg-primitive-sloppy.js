...
asyncTest(async () => {
  ...
  await Array.fromAsync([1, 2, 3], async function () {
    ...
    assert(this instanceof String, "a String wrapper object should be bound as the this-value of mapfn when thisArg is a string")
  ...
  await Array.fromAsync([1, 2, 3], async function () {
    ...
    assert(this instanceof Number, "a Number wrapper object should be bound as the this-value of mapfn when thisArg is a number")
  ...
  await Array.fromAsync([1, 2, 3], async function () {
    ...
    assert(this instanceof BigInt, "a BigInt wrapper object should be bound as the this-value of mapfn when thisArg is a bigint")
  ...
  await Array.fromAsync([1, 2, 3], async function () {
    ...
    assert(this instanceof Boolean, "a Boolean wrapper object should be bound as the this-value of mapfn when thisArg is a boolean")
  ...
  await Array.fromAsync([1, 2, 3], async function () {
    ...
    assert(this instanceof Symbol, "a Symbol wrapper object should be bound as the this-value of mapfn when thisArg is a symbol")
