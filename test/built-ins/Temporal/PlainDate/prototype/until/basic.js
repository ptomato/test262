...
TemporalHelpers.assertDuration(plainDate2.until(plainDate), 0, 0, 0, /* days = */ -73, 0, 0, 0, 0, 0, 0, "same year, negative");
...
TemporalHelpers.assertDuration(later.until(earlier), 0, 0, 0, /* days = */ -9719, 0, 0, 0, 0, 0, 0, "different year, negative");
