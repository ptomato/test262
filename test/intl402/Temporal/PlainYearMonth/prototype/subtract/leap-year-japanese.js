...
TemporalHelpers.assertPlainYearMonth(
  ...
  2020, 2, "M02", "add 5mo with result in the next year",
  "reiwa", 2);
...
TemporalHelpers.assertPlainYearMonth(
  ...
  2024, 2, "M02", "add 1y 2mo with result in the next year",
  "reiwa", 6);
...
TemporalHelpers.assertPlainYearMonth(
  ...
  2020, 2, "M02", "add 11mo with result in the next year",
  "reiwa", 2);
...
TemporalHelpers.assertPlainYearMonth(
  ...
  2020, 2, "M02", "add 1y 2mo with result in the previous year",
  "reiwa", 2);
