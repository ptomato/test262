...
TemporalHelpers.assertPlainYearMonth(
  ...
  109, 2, "M02", "add 5mo with result in the next year",
  "roc", 109);
...
TemporalHelpers.assertPlainYearMonth(
  ...
  113, 2, "M02", "add 1y 2mo with result in the next year",
  "roc", 113);
...
TemporalHelpers.assertPlainYearMonth(
  ...
  109, 2, "M02", "add 11mo with result in the next year",
  "roc", 109);
...
TemporalHelpers.assertPlainYearMonth(
  ...
  109, 2, "M02", "add 1y 2mo with result in the previous year",
  "roc", 109);
