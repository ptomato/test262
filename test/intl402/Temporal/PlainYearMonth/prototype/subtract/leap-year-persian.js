...
TemporalHelpers.assertPlainYearMonth(
  ...
  1362, 12, "M12", "add 1y 2mo with result in the next year",
  "ap", 1362, null);
...
TemporalHelpers.assertPlainYearMonth(
  ...
  1362, 12, "M12", "subtract 11mo with result in the previous year",
  "ap", 1362, null);
...
TemporalHelpers.assertPlainYearMonth(
  ...
  1363, 12, "M12", "add 1y 2mo with result in the previous year",
  "ap", 1363, null);
