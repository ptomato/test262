...
TemporalHelpers.assertPlainYearMonth(
  ...
  2563, 2, "M02", "add 5mo with result in the next year",
  "be", 2563);
...
TemporalHelpers.assertPlainYearMonth(
  ...
  2567, 2, "M02", "add 1y 2mo with result in the next year",
  "be", 2567);
...
TemporalHelpers.assertPlainYearMonth(
  ...
  2563, 2, "M02", "add 11mo with result in the next year",
  "be", 2563);
...
TemporalHelpers.assertPlainYearMonth(
  ...
  2563, 2, "M02", "add 1y 2mo with result in the previous year",
  "be", 2563);
