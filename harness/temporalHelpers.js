  ...
  ISO: {
    instantStringsInvalid() {
      return [
        ...
        "2020-01-01T00:00+24:00",
        // valid in full ISO 8601, but forms not supported in RFC 9557:
        "2020-W01-1T00:00Z",
        "2020-001T00:00Z",
        "+0002020-01-01T00:00Z",
        // may be valid in other contexts, but cannot be parsed as Instant:
        "2020-01",
        "+002020-01",
        "01-01",
        "2020-W01",
    ...
    plainDateStringsInvalid() {
      return [
        ...
        // may be valid in other contexts, but cannot be parsed as PlainDate:
        "2020-01",
        "+002020-01",
        "01-01",
        "2020-W01",
    ...
    plainDateTimeStringsInvalid() {
      return [
        ...
        // valid, but this calendar must not exist:
        "2020-01-01[u-ca=notexist]",
        // may be valid in other contexts, but cannot be parsed as PlainDateTime
        "2020-01",
        "+002020-01",
        "01-01",
        "2020-W01",
    ...
    plainMonthDayStringsInvalid() {
      return [
        ...
        "+999999-01-01[u-ca=gregory]",
        "+999999-01-01[u-ca=chinese]",
        "1976-10-01T00:00:00+00:0000",
        "1976-10-01T00:00:00+0000:00",
      ];
    },
    ...
    plainYearMonthStringsInvalid() {
      return [
        ...
        "+999999-01",
        "-999999-01",
        "1976-11-01T00:00:00+00:0000",
        "1976-11-01T00:00:00+0000:00",
      ];
    },
